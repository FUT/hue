...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { author: @text.author, description: @text.description, source: @text.source, source_date: @text.source_date, title: @text.title }
    end
  ...
  test "should update text" do
    put :update, id: @text, text: { author: @text.author, description: @text.description, source: @text.source, source_date: @text.source_date, title: @text.title }
    assert_redirected_to text_path(assigns(:text))
  end
