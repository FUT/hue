...
class CheckpointsControllerTest < ActionController::TestCase
  ...
  test "should create checkpoint" do
    assert_difference('Checkpoint.count') do
      post :create, checkpoint: { description: @checkpoint.description, length: @checkpoint.length, seconds: @checkpoint.seconds, title: @checkpoint.title, user_id: @checkpoint.user_id }
    end
  ...
  test "should update checkpoint" do
    put :update, id: @checkpoint, checkpoint: { description: @checkpoint.description, length: @checkpoint.length, seconds: @checkpoint.seconds, title: @checkpoint.title, user_id: @checkpoint.user_id }
    assert_redirected_to checkpoint_path(assigns(:checkpoint))
  end
